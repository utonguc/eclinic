...
export const metadata: Metadata = {
  ...
  description:
    "e-Clinic; klinik ve muayerehane süreçlerini uçtan uca dijitalleştiren bulut tabanlı SaaS platformdur. Randevu yönetimi, hasta takibi, faturalandırma, AI destekli arama ve anket modülleriyle kliniğinizin verimliliğini katlayın.",
  keywords: [
    "klinik yönetim yazılımı", "muayenehane yazılımı", "hasta randevu sistemi",
    "doktor takip programı", "klinik CRM", "e-Clinic xShield", "hastane yönetim sistemi",
